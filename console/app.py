...
def handle_api(
    ...
    if path == "/api/corpus/lab/feature" and method == "POST":
        ...
        result = feature_variant(
            ...
            structure_name=str(body.get("structure_name") or body.get("formula") or ""),
            production_line=str(body.get("production_line") or ""),
            number_part=str(body.get("number_part") or ""),
            engagement=str(body.get("engagement") or "静"),
