...
2. **设置 GitHub Secrets（选择你需要的平台）**:
   ...
   **设置步骤：**
   ...
   1. **查看生成的 URL**：
      ...
      - 格式如：`https://hooks.slack.com/services/YOUR_WORKSPACE/YOUR_CHANNEL/YOUR_WEBHOOK_TOKEN`
...
# Slack多账号（2个频道）
SLACK_WEBHOOK_URL=https://hooks.slack.com/services/YOUR_WORKSPACE1/YOUR_CHANNEL1/YOUR_TOKEN1;https://hooks.slack.com/services/YOUR_WORKSPACE2/YOUR_CHANNEL2/YOUR_TOKEN2
```
